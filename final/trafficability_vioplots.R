...
FiguresDir <- file.path(mainDir, 'Figures', 'final')
resultsDir <- 'D:/PostDoc/Trafficability/climate_runs'
MonthlyMeansDir <- file.path(resultsDir, 'overall_summaries_final/by_cell/monthly_means')
library(vioplot)
library(extrafont)
library(extrafontdb)
...
vioplot_traffic_all <- function(fname,  ylim_vioplot, mar, fig_height, fig_width, month, savename, axis_line, lab_ht) {
  ...
  par(mar=mar)
  vioplot(df[,4][df$textural_class==texture_colors$textures[1]], df[,4][df$textural_class==texture_colors$textures[2]], df[,4][df$textural_class==texture_colors$textures[3]], df[,4][df$textural_class==texture_colors$textures[4]], df[,4][df$textural_class==texture_colors$textures[5]], df[,4][df$textural_class==texture_colors$textures[6]], df[,4][df$textural_class==texture_colors$textures[7]], df[,4][df$textural_class==texture_colors$textures[8]], df[,4][df$textural_class==texture_colors$textures[9]], df[,4][df$textural_class==texture_colors$textures[10]], col=rgb(texture_colors$red/255, texture_colors$green/255, texture_colors$blue/255), wex=1, cex=0.3, rectCol = 'gray', pchMed = 1, colMed = 'black', ylim = ylim_vioplot, ylab = NULL, xaxt = 'n')
  axis(side = 1, at=1:10, texture_colors$texture_labs, line=axis_line, tick = FALSE, cex.axis=0.6)
  # mtext('Textural classes (0-10 cm)', side = 1, line = 0.5)
  mtext(paste0('Days to trafficability after flooding'), side=2, line=2.5)
  text(x=10, y=lab_ht, labels=month)
  dev.off()
}

vioplot_traffic_all(fname = 'cell_181807_Jan.csv', ylim_vioplot = c(0,65), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3.5, fig_width=4.75, month='January', savename = 'cell_181807_Jan.tif', axis_line = -2, lab_ht = 65) #fname,  ylim_vioplot, mar, fig_label, fig_height, month, savename
vioplot_traffic_all(fname = 'cell_181807_Feb.csv', ylim_vioplot = c(0,65), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3.5, fig_width=4.75, month='February', savename = 'cell_181807_Feb.tif', axis_line = -2, lab_ht = 65)
vioplot_traffic_all(fname = 'cell_181807_Mar.csv', ylim_vioplot = c(0,45), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3.5, fig_width=4.75, month='March', savename = 'cell_181807_Mar.tif', axis_line = -2, lab_ht = 45)
vioplot_traffic_all(fname = 'cell_181807_Apr.csv', ylim_vioplot = c(0,45), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3.5, fig_width=4.75, month='April', savename = 'cell_181807_Apr.tif', axis_line = -2, lab_ht = 45)
...
vioplot_traffic_loamy_coarse(fname = 'cell_181807_Mar.csv', ylim_vioplot = c(0,37), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3.25, fig_width=4.75, month='March', savename = 'cell_181807_Mar_loamy_coarse.tif', axis_line = -2, col_index=3:10, lab_ht = 37, ylab = TRUE)
vioplot_traffic_loamy_coarse(fname = 'cell_181807_Apr.csv', ylim_vioplot = c(0,37), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3.25, fig_width=4.75, month='April', savename = 'cell_181807_Apr_loamy_coarse.tif', axis_line = -2, col_index=3:10, lab_ht = 37, ylab = FALSE)
...
vioplot_traffic_texture <- function(cellname, texture, to_plot, ylim_vioplot, mar, fig_label, fig_height, fig_width, savename, axis_line,  lab_ht, ylab) {
  ...
  legend('top', legend =  texture, bty = 'n')
  legend('topleft', legend = fig_label, bty='n', inset = c(-0.05, 0))
  dev.off()
}
vioplot_traffic_texture(cellname = 'cell_181807', texture = 'sandy loam', ylim_vioplot = c(0,44), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3, fig_width=3, savename = 'cell_181807_sandy_loam.tif', axis_line = -2, lab_ht = 44, ylab = TRUE, fig_label = 'e')
vioplot_traffic_texture(cellname = 'cell_181807', texture = 'loam', ylim_vioplot = c(0,65), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3, fig_width=3, savename = 'cell_181807_loam.tif', axis_line = -2, lab_ht = 65, ylab = TRUE, fig_label = 'e')
vioplot_traffic_texture(cellname = 'cell_181807', texture = 'loamy sand', ylim_vioplot = c(0,24), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3, fig_width=3, savename = 'cell_181807_loamy_sand.tif', axis_line = -2, lab_ht = 24, ylab = TRUE, fig_label = 'a')
vioplot_traffic_texture(cellname = 'cell_181807', texture = 'sand', ylim_vioplot = c(0,24), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3, fig_width=3, savename = 'cell_181807_sand.tif', axis_line = -2, lab_ht = 24, ylab = TRUE, fig_label = 'b')
vioplot_traffic_texture(cellname = 'cell_181807', texture = 'clay', ylim_vioplot = c(0,65), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3, fig_width=3, savename = 'cell_181807_clay.tif', axis_line = -2, lab_ht = 65, ylab = TRUE, fig_label = 'a')
vioplot_traffic_texture(cellname = 'cell_181807', texture = 'silty clay', ylim_vioplot = c(0,65), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3, fig_width=3, savename = 'cell_181807_silty_clay.tif', axis_line = -2, lab_ht = 65, ylab = TRUE, fig_label = 'b')
vioplot_traffic_texture(cellname = 'cell_181807', texture = 'clay loam', ylim_vioplot = c(0,44), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3, fig_width=3, savename = 'cell_181807_clay_loam.tif', axis_line = -2, lab_ht = 44, ylab = TRUE, fig_label = 'd')

vioplot_traffic_texture(cellname = 'cell_181807', texture = 'silty clay loam', ylim_vioplot = c(0,65), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3, fig_width=3, savename = 'cell_181807_silty_clay_loam.tif', axis_line = -2, lab_ht = 65, ylab = TRUE, fig_label = 'c')
vioplot_traffic_texture(cellname = 'cell_181807', texture = 'silt loam', ylim_vioplot = c(0,65), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3, fig_width=3, savename = 'cell_181807_silt_loam.tif', axis_line = -2, lab_ht = 65, ylab = TRUE, fig_label = 'd')
vioplot_traffic_texture(cellname = 'cell_181807', texture = 'sandy clay loam', ylim_vioplot = c(0,24), mar = c(0.1, 3.5, 0.1, 0.1), fig_height = 3, fig_width=3, savename = 'cell_181807_sandy_clay_loam.tif', axis_line = -2, lab_ht = 24, ylab = TRUE, fig_label = 'c')
